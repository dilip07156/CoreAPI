...
namespace VGER_WAPI_CLASSES
{
    public class mQRFPosition
    {
        ...
        public List<QRFRoomDetailsInfo> RoomDetailsInfo { get; set; } = new List<QRFRoomDetailsInfo>();
        
        public List<QRFPositionFOC> QRFPositionFOC { get; set; } = new List<QRFPositionFOC>();
    ...
    public class QRFRoomDetailsInfo
    {
        ...
        [BsonIgnoreIfNull(true)]
        public string CrossPosition { get; set; }
